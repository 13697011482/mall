...
export default {
    ...
    methods: {
        ...
        scrollContent: function(currnetPosition) {
            this.scrolling = true;

            this.swiperStyle.transition = 'transform' + this.animDuration + 'ms';
            this.setTransform(currnetPosition);
        ...
        checkPosition: function() {
            window.setTimeout(() => {
                ...
                this.$emit('transtionEnd', this.currentIndex - 1);
            }, this.animDuration)
        },
        ...
        setTransform: function(position) {
            ...
            this.swiperStyle['-ms-transfrom'] = `translate3d(${position}px), 0, 0`;
        ...
        touchMove: function (e) {
            ...
            let currnetPosition = -this.currentIndex * this.totalWidth;
